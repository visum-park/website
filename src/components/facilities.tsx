      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <FacilityCard
            ...
            imageSrc="https://images.unsplash.com/photo-1740478297724-45438d31a4bb?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxvdXRkb29yJTIwZ2FyZGVuJTIwdGVhbWJ1aWxkaW5nfGVufDF8fHx8MTc3MTMzMTAwM3ww&ixlib=rb-4.1.0&q=80&w=1080"
            delay={0.4}
            darkMode={darkMode}
          />
          <FacilityCard
